    ...
    return (
        <div className='relative'>
            <div className="border-2 p-2 rounded-xl">
                <div className="text-center bg-purple-600 rounded-xl h-[480px] pt-4">
                    <div className="text-white">
                        <h1 className="md:w-3/4 mx-auto text-3xl md:text-4xl  lg:text-6xl font-bold">Upgrade Your Tech Accessorize with Gadget Heaven Accessories</h1>
