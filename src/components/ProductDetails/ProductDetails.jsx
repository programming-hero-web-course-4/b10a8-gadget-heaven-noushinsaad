                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="lg:w-3/5 rounded-xl p-3 space-y-4">
                        ...
                        <div className="flex gap-2">
                            <button className="flex items-center btn rounded-full">Add to Cart <IoCartOutline className="text-2xl" /></button>
                            <button className="btn rounded-full"><IoIosHeartEmpty className="text-2xl" /></button>
                        </div>
                    </div>
                </div>
            </div>
